...
public final class SLSubNodeGen extends SLSubNode {
    ...
    public Object executeGeneric(VirtualFrame frameValue) {
        ...
        if ((state_0 & 0b110) == 0 /* only-active sub(long, long) */ && ((state_0 & 0b111) != 0  /* is-not sub(long, long) && sub(SLBigNumber, SLBigNumber) && typeError(Object, Object) */)) {
    ...
    private Object executeGeneric_long_long0(int state_0, VirtualFrame frameValue) {
        ...
        assert (state_0 & 0b1) != 0 /* is-state_0 sub(long, long) */;
        try {
            ...
            lock.lock();
            try {
                this.exclude_ = this.exclude_ | 0b1 /* add-exclude sub(long, long) */;
                this.state_0_ = this.state_0_ & 0xfffffffe /* remove-state_0 sub(long, long) */;
            } finally {
                lock.unlock();
            }
    ...
    private Object executeGeneric_generic1(int state_0, VirtualFrame frameValue) {
        ...
        if ((state_0 & 0b1) != 0 /* is-state_0 sub(long, long) */ && leftNodeValue_ instanceof Long) {
        ...
        if ((state_0 & 0b10) != 0 /* is-state_0 sub(SLBigNumber, SLBigNumber) */ && SLTypesGen.isImplicitSLBigNumber((state_0 & 0b11000) >>> 3 /* extract-implicit-state_0 0:SLBigNumber */, leftNodeValue_)) {
    ...
    public long executeLong(VirtualFrame frameValue) throws UnexpectedResultException {
        ...
        if ((state_0 & 0b1) != 0 /* is-state_0 sub(long, long) */) {
            try {
                return sub(leftNodeValue_, rightNodeValue_);
            } catch (ArithmeticException ex) {
                CompilerDirectives.transferToInterpreterAndInvalidate();
    ...
    private Object executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
        ...
        try {
            ...
            if ((exclude) == 0 /* is-not-exclude sub(long, long) */ && leftNodeValue instanceof Long) {
                long leftNodeValue_ = (long) leftNodeValue;
                if (rightNodeValue instanceof Long) {
                    long rightNodeValue_ = (long) rightNodeValue;
                    this.state_0_ = state_0 = state_0 | 0b1 /* add-state_0 sub(long, long) */;
                    try {
                        lock.unlock();
                        hasLock = false;
                        return sub(leftNodeValue_, rightNodeValue_);
            ...
            }
            {
                ...
                if ((sLBigNumberCast0 = SLTypesGen.specializeImplicitSLBigNumber(leftNodeValue)) != 0) {
                    ...
                    if ((sLBigNumberCast1 = SLTypesGen.specializeImplicitSLBigNumber(rightNodeValue)) != 0) {
                        ...
                        this.state_0_ = state_0 = state_0 | 0b10 /* add-state_0 sub(SLBigNumber, SLBigNumber) */;
                        lock.unlock();
                        hasLock = false;
                        return sub(leftNodeValue_, rightNodeValue_);
                    }
