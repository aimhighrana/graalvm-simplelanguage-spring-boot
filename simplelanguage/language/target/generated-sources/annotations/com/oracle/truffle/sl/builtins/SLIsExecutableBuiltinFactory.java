...
public final class SLIsExecutableBuiltinFactory implements NodeFactory<SLIsExecutableBuiltin> {
    ...
    public static final class SLIsExecutableBuiltinNodeGen extends SLIsExecutableBuiltin {
        ...
        private Object isExecutable1Boundary(int state_0, Object arguments0Value_) {
            ...
            try {
                {
                    InteropLibrary isExecutable1_executables__ = (INTEROP_LIBRARY_.getUncached(arguments0Value_));
                    return isExecutable(arguments0Value_, isExecutable1_executables__);
                }
            } finally {
            ...
            try {
                ...
                if ((exclude) == 0 /* is-not-exclude isExecutable(Object, InteropLibrary) */) {
                    ...
                    if (s0_ == null) {
                        ...
                        if (count0_ < (3)) {
                            ...
                            s0_.executables_ = s0_.insertAccessor((INTEROP_LIBRARY_.create(arguments0Value)));
                ...
                }
                {
                    InteropLibrary isExecutable1_executables__ = null;
                    {
                        ...
                        Node prev_ = encapsulating_.set(this);
                        try {
                            isExecutable1_executables__ = (INTEROP_LIBRARY_.getUncached(arguments0Value));
                            ...
                            lock.unlock();
                            hasLock = false;
                            return isExecutable(arguments0Value, isExecutable1_executables__);
                        } finally {
                            encapsulating_.set(prev_);
                        }
                    }
