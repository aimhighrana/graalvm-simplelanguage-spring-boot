...
public final class SLLessThanNodeGen extends SLLessThanNode {
    ...
    public Object executeGeneric(VirtualFrame frameValue) {
        ...
        if ((state_0 & 0b110) == 0 /* only-active lessThan(long, long) */ && ((state_0 & 0b111) != 0  /* is-not lessThan(long, long) && lessThan(SLBigNumber, SLBigNumber) && typeError(Object, Object) */)) {
    ...
    private Object executeGeneric_generic1(int state_0, VirtualFrame frameValue) {
        ...
        if ((state_0 & 0b1) != 0 /* is-state_0 lessThan(long, long) */ && leftNodeValue_ instanceof Long) {
        ...
        if ((state_0 & 0b10) != 0 /* is-state_0 lessThan(SLBigNumber, SLBigNumber) */ && SLTypesGen.isImplicitSLBigNumber((state_0 & 0b11000) >>> 3 /* extract-implicit-state_0 0:SLBigNumber */, leftNodeValue_)) {
    ...
    public void executeVoid(VirtualFrame frameValue) {
        int state_0 = this.state_0_;
        try {
            if ((state_0 & 0b100) == 0 /* only-active lessThan(long, long) && lessThan(SLBigNumber, SLBigNumber) */ && ((state_0 & 0b111) != 0  /* is-not lessThan(long, long) && lessThan(SLBigNumber, SLBigNumber) && typeError(Object, Object) */)) {
    ...
    private Object executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
        ...
        if (leftNodeValue instanceof Long) {
            ...
            if (rightNodeValue instanceof Long) {
                ...
                this.state_0_ = state_0 = state_0 | 0b1 /* add-state_0 lessThan(long, long) */;
                return lessThan(leftNodeValue_, rightNodeValue_);
            }
        }
        {
            ...
            if ((sLBigNumberCast0 = SLTypesGen.specializeImplicitSLBigNumber(leftNodeValue)) != 0) {
                ...
                if ((sLBigNumberCast1 = SLTypesGen.specializeImplicitSLBigNumber(rightNodeValue)) != 0) {
                    ...
                    this.state_0_ = state_0 = state_0 | 0b10 /* add-state_0 lessThan(SLBigNumber, SLBigNumber) */;
                    return lessThan(leftNodeValue_, rightNodeValue_);
                }
            }
        }
