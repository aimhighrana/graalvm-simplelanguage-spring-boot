...
public final class SLDefineFunctionBuiltinFactory implements NodeFactory<SLDefineFunctionBuiltin> {
    ...
    public static final class SLDefineFunctionBuiltinNodeGen extends SLDefineFunctionBuiltin {
        ...
        protected Object execute(VirtualFrame frameValue) {
            ...
            if (state_0 != 0 /* is-state_0 defineFunction(TruffleString) */ && arguments0Value_ instanceof TruffleString) {
        ...
        private TruffleString executeAndSpecialize(Object arguments0Value) {
            ...
            if (arguments0Value instanceof TruffleString) {
                ...
                this.state_0_ = state_0 = state_0 | 0b1 /* add-state_0 defineFunction(TruffleString) */;
