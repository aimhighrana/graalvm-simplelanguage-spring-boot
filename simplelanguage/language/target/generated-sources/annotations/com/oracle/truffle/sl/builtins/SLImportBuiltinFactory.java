...
public final class SLImportBuiltinFactory implements NodeFactory<SLImportBuiltin> {
    ...
    public static final class SLImportBuiltinNodeGen extends SLImportBuiltin {
        ...
        protected Object execute(VirtualFrame frameValue) {
            ...
            if (state_0 != 0 /* is-state_0 importSymbol(TruffleString, ToJavaStringNode, InteropLibrary) */ && arguments0Value_ instanceof TruffleString) {
                TruffleString arguments0Value__ = (TruffleString) arguments0Value_;
                return importSymbol(arguments0Value__, this.toJavaStringNode_, this.arrays_);
            }
        ...
        private Object executeAndSpecialize(Object arguments0Value) {
            ...
            try {
                ...
                if (arguments0Value instanceof TruffleString) {
                    ...
                    this.state_0_ = state_0 = state_0 | 0b1 /* add-state_0 importSymbol(TruffleString, ToJavaStringNode, InteropLibrary) */;
                    lock.unlock();
                    hasLock = false;
                    return importSymbol(arguments0Value_, this.toJavaStringNode_, this.arrays_);
                }
